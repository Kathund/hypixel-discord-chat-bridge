...
class UpdateCodeScript extends BasicScript {
  constructor(scripts: ScriptManager) {
    super(scripts, { id: "updateCode", enabled: scripts.application.config.other.codeUpdater.enabled, interval: scripts.application.config.other.codeUpdater.interval });
